...
`phar://`能被更多的函数触发，如`file_exeit unline`，通常可以直接使用`phar://`做文件解压缩操作已直接访问压缩包内的文件
...
![image-20240223160712261](%E6%A9%99%E5%AD%90%E7%A7%91%E6%8A%80.assets/image-20240223160712261.png)
...
**Tips：**一个HTTP头部必须包含下面的两条字段，*且每个字段后面必须跟一个回车*
