...
[root@localhost vsftpd]# mkdir /samba/share -p
...
```bash
[root@samba ~]# smbclient //192.168.231.130/anon_share
Enter SAMBA\root's password:
Anonymous login successful
Try "help" to get a list of possible commands.
smb: \>
...
```bash
[root@localhost named]# cp -p /var/named/named.loopback /var/named/192.168.1.zone
